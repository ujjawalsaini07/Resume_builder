...
const MinimalImageTemplate = ({ data, accentColor }) => {
    ...
    const profileBackgroundColor = `${accentColor}33`;
            ...
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-1  py-10">
                    ...
                    {data.personal_info?.image && typeof data.personal_info.image === 'string' ? (
                        <div className="mb-6">
                            <div className="w-32 h-32 rounded-full mx-auto overflow-hidden" style={{ backgroundColor: profileBackgroundColor }}>
                                <img src={data.personal_info.image} alt="Profile" className="w-full h-full object-contain" />
                            </div>
                        </div>
                    ) : (
                        data.personal_info?.image && typeof data.personal_info.image === 'object' ? (
                            <div className="mb-6">
                                <div className="w-32 h-32 rounded-full mx-auto overflow-hidden" style={{ backgroundColor: profileBackgroundColor }}>
                                    <img src={URL.createObjectURL(data.personal_info.image)} alt="Profile" className="w-full h-full object-contain" />
                                </div>
                            </div>
                        ) : null
                    )}
